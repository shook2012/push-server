 ...
 */
package es.tor.push.android;

import static es.tor.push.android.Constants.GCM_SEND_ENDPOINT;
import static es.tor.push.android.Constants.JSON_CANONICAL_IDS;
import static es.tor.push.android.Constants.JSON_ERROR;
import static es.tor.push.android.Constants.JSON_FAILURE;
import static es.tor.push.android.Constants.JSON_MESSAGE_ID;
import static es.tor.push.android.Constants.JSON_MULTICAST_ID;
import static es.tor.push.android.Constants.JSON_PAYLOAD;
import static es.tor.push.android.Constants.JSON_REGISTRATION_IDS;
import static es.tor.push.android.Constants.JSON_RESULTS;
import static es.tor.push.android.Constants.JSON_SUCCESS;
import static es.tor.push.android.Constants.PARAM_COLLAPSE_KEY;
import static es.tor.push.android.Constants.PARAM_DELAY_WHILE_IDLE;
import static es.tor.push.android.Constants.PARAM_PAYLOAD_PREFIX;
import static es.tor.push.android.Constants.PARAM_REGISTRATION_ID;
import static es.tor.push.android.Constants.PARAM_TIME_TO_LIVE;
import static es.tor.push.android.Constants.TOKEN_CANONICAL_REG_ID;
import static es.tor.push.android.Constants.TOKEN_ERROR;
import static es.tor.push.android.Constants.TOKEN_MESSAGE_ID;

import es.tor.push.android.Result.Builder;
...
public class Sender {
	...
	private final String key = "AIzaSyBClMwWCcJMuajUNoEeCwQidPflqoPvgIM";
	...
	public MulticastResult sendNoRetry(Message message,
		...
		String requestBody = mapper.writeValueAsString(jsonRequest); // JSONValue.toJSONString(jsonRequest);
		...
		Map<String, Object> jsonResponse = mapper.readValue(responseBody, new TypeReference<Map<String, Object>>() { });
		/*Map<String, Object> jsonResponse = gson.fromJson(requestBody,
				new TypeToken<Map<String, Object>>() {
				}.getType());*/
		int success = (Integer) jsonResponse.get(JSON_SUCCESS);
		int failure = (Integer) jsonResponse.get(JSON_FAILURE);
		int canonicalIds = (Integer) jsonResponse.get(JSON_CANONICAL_IDS);
		long multicastId = (Long) jsonResponse.get(JSON_MULTICAST_ID);
		MulticastResult.Builder builder = new MulticastResult.Builder(success,
				failure, canonicalIds, multicastId);
